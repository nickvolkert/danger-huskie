        ...
        <Content>
            ...
            <div id="news-body" className="body-copy">
                ...
                <div className="news-entry">
                    <div className="leftRail">
                        <div className="leftRailImage">
                            <Link to={DangerHuskie[41].link}>
                                <img src={DangerHuskie[41].preview} title={DangerHuskie[41].title} alt={DangerHuskie[41].alttext} />
                            </Link>
                        </div>
                        <p className="caption">Pointy teeth!</p>
                    </div>
                    <div className="rightRail">
                        <h2>Pointy teeth incoming!</h2>
                        <div className="pipe"></div>
                        <div className="news-entry-text">
                        <p>Date: April 14th, 2024</p>
                        <p>DANGER TEAM: A bloodthirsty horror emerges from it's slumber! The Vampire fangs, ehmphasis on fangs, is looking for fresh blood!</p>
                        <p><Link to={DangerHuskie[41].link}>Check out the {DangerHuskie[41].title} here!</Link></p>
                        <p><Link to="/works/">Check out ALL my latest works here!</Link></p>
                        <p>~ Danger Nick</p>
                    </div>
                    </div>
                ...
                <div className="news-entry">
                    <div className="leftRail">
                        <div className="leftRailImage">
                            <Link to={DangerHuskie[39].link}>
                                <img src={DangerHuskie[39].preview} title={DangerHuskie[39].title} alt={DangerHuskie[39].alttext} />
                            </Link>
                        </div>
                        <p className="caption">Happy St. Patrick's Day Weekend!</p>
                    </div>
                    <div className="rightRail">
                        <h2>Super Lucky Chicago-Style Dogs...</h2>
                        <div className="pipe"></div>
                        <div className="news-entry-text">
                        <p>Date: March 16th, 2024</p>
                        <p>DANGER TEAM: It's entry TWO in my new chicago-style dog trifecta, and this one is a very lucky dawg!</p>
                        <p><Link to={DangerHuskie[39].link}>Check out the {DangerHuskie[39].title} here!</Link></p>
                        <p><Link to="/works/">Check out ALL my latest works here!</Link></p>
                        <p>~ Danger Nick</p>
                    </div>
                    </div>
                ...
                <div className="news-entry">
                    <div className="leftRail">
                        <div className="leftRailImage">
                            <Link to={DangerHuskie[38].link}>
                                <img src={DangerHuskie[38].preview} title={DangerHuskie[38].title} alt={DangerHuskie[38].alttext} />
                            </Link>
                        </div>
                        <p className="caption">It's almost St. Patrick's Day...</p>
                    </div>
                    <div className="rightRail">
                        <h2>Green Chicago Dogs...</h2>
                        <div className="pipe"></div>
                        <div className="news-entry-text">
                        <p>Date: March 13th, 2024</p>
                        <p>DANGER TEAM: I'm dropping my first of a trifecta of new St. Patrick's Day themed Chicago dogs!</p>
                        <p><Link to={DangerHuskie[38].link}>Check out the {DangerHuskie[38].title} here!</Link></p>
                        <p><Link to="/works/">Check out ALL my latest works here!</Link></p>
                        <p>~ Danger Nick</p>
                    </div>
                    </div>
